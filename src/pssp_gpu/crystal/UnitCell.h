...
namespace Pscf{
   ...
   */
                              ...
                              UnitCell<D>& cell)
   {
      ...
      /*for (int i = 0; i < 6; ++i) {
        std::cout<<"Parameter = "<<cell.parameters_[i];
      }*/   
      cell.setLattice();
      return in;
   }
   ...
   */
   ...
   public:
      ...
      * ostream inserter for a UnitCell<D>::LatticeSystem.
      *
      * \param out  output stream for field format
      */
      ...
      * ostream inserter for a UnitCell<D>::LatticeSystem.
      *
      * \param in input stream for field format
      */
   ...
   */
   ...
   inline
   void UnitCell<1>::writeHeader(std::ostream& out)
   { 
      out << "crystal_system    " <<  std::endl << "                    " <<lattice_<<std::endl;
      out << "N_cell_param    " <<  std::endl << "                    "<<nParameter_<< std::endl;
      out << "cell_param    " <<  std::endl;
      for (int i = 0; i < nParameter_; ++i) {
         out <<"                  "<< Dbl(parameters_[i], 18, 10);
      }
      out<<std::endl;
   }
    
   inline
   void UnitCell<1>::readHeader(std::istream& in)
   {
      ...
      in >> nParametersIn;
      UTIL_CHECK(nParametersIn == nParameter_);
       
      in >> label;
      UTIL_CHECK(label == "cell_param");
        
      for (int i = 0; i < nParameter_; ++i) {
          in >>std::setprecision(15)>>parameters_[i];
      }
   ...
   */
   ...
   inline
   void UnitCell<2>::writeHeader(std::ostream& out)
   { 
      out << "crystal_system    " <<  std::endl << "                    " <<lattice_<<std::endl;
      out << "N_cell_param    " <<  std::endl << "                    "<<nParameter_<< std::endl;
      out << "cell_param    " <<  std::endl;
   ...
   inline
   void UnitCell<2>::readHeader(std::istream& in)
   {    
      std::string label;
      int nParametersIn;
   ...
   */
   ...
   inline
   void UnitCell<3>::writeHeader(std::ostream& out)
   {  
      out << "crystal_system    " <<  std::endl << "                    " <<lattice_<<std::endl;
      out << "N_cell_param    " <<  std::endl << "                    "<<nParameter_<< std::endl;
      out << "cell_param    " <<  std::endl;
   ...
   inline
   void UnitCell<3>::readHeader(std::istream& in)
   {
