# ---------------------------------------------------------------------
# File: src/cpg/patterns.mk
#
# This makefile fragment contains the pattern rule used to compile all 
# sources files in the directory tree rooted at the src/cpg directory. 
...
PSCF_LIBS=$(cpg_LIB) $(prdc_LIB) $(pscf_LIB) $(util_LIB)

# List of all libraries needed in src/cpg (including external libraries)
LIBS=$(PSCF_LIBS)
...
# Pattern rule to compile *.cpp C++ source files in src/cpg
...
# Pattern rule to compile *.cu CUDA source files in src/cpg
# Note: Creates a *.d dependency file as a side effect 
...
# Pattern rule to link executable Test programs in src/cpg/tests
