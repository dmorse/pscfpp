#ifndef PRDC_FIELD_BASIS_CONVERTER_CP_TPP
#define PRDC_FIELD_BASIS_CONVERTER_CP_TPP
...
namespace Prdc {
   ...
   */
   template <int D> 
   void 
   FieldBasisConverter<D>::convertToBasis(DArray< RField<D,CPT> > const & in,
   ...
   */
   template <int D> 
   void 
   FieldBasisConverter<D>::convertFromBasis(DArray< RField<D,CPT> > const & in,
                                            DArray< RField<D,CPT> > & out,
                                            double prefactor) const
   {
      // Preconditions
