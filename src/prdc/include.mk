...
# directory.  It must be included after the config.mk in the root of the #
# build directory (referred to by a relative path), which defines        #
# values for the macros $(BLD_DIR) and $(SRC_DIR) as absolute paths.     #
# ---------------------------------------------------------------------- #
