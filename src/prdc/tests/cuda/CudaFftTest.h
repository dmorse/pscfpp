...
void CudaFftTest::testTransformReal1D() 
{
   ...
   HostArray<cudaReal> rField1_h(rSize), 
                        rField2_h(rSize), 
                        rField3_h(rSize);
   HostArray<cudaComplex> kField1_h(kField.capacity()), 
...
void CudaFftTest::testTransformComplex1D() 
{
   ...
   Prdc::CField<1,CUT> rField(d), 
                         kField(d);
   HostArray<cudaComplex> rField1_h(rSize), 
                           rField2_h(rSize), 
                           rField3_h(rSize), 
                           kField1_h(rSize), 
                           kField2_h(rSize);
...
void CudaFftTest::testBatchedTransformReal1D() 
{
   ...
   HostArray<cudaComplex> kField_h(kField.capacity());
...
void CudaFftTest::testBatchedTransformReal2D() 
{
   ...
   Prdc::FFT<2,CUT> altFFT;
   altFFT.setup(d);
   Prdc::RField<2,CUT> rFieldAlt;
   rFieldAlt.associate(rField, 0, d);
...
void CudaFftTest::testBatchedTransformReal3D() 
{
   ...
   Prdc::FFT<3,CUT> altFFT;
   altFFT.setup(d);
   Prdc::RField<3,CUT> rFieldAlt;
   rFieldAlt.associate(rField, 0, d);
