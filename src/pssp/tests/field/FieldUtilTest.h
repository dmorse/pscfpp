#ifndef PSSP_FIELD_UTIL_TEST_H
#define PSSP_FIELD_UTIL_TEST_H

#include <test/UnitTest.h>
#include <test/UnitTestRunner.h>

#include <pssp/field/fieldUtil.h>
...
class FieldUtilTest : public UnitTest 
{
...
public:
   ...
   void testFieldConversion2D()
   {
      ...
      convertFieldDftToBasis(basis, kField, components);
      ...
      //           << std::endl;
      convertFieldBasisToDft(basis, components, kFieldAlt);
...
TEST_BEGIN(FieldUtilTest)
TEST_ADD(FieldUtilTest, testFieldConversion2D)
TEST_ADD(FieldUtilTest, testFieldConversion3D)
TEST_END(FieldUtilTest)
