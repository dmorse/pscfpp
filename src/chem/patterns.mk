...
# files in the directory tree rooted at the src/chem directory, which
...
# the files src/config.mk and src/chem/config.mk because this file
# uses makefile variables defined in those files.
#-----------------------------------------------------------------------

# All libraries needed in src/chem
LIBS=$(chem_LIB) $(util_LIB)

# Preprocessor macro definitions needed in src/chem
DEFINES=$(UTIL_DEFS)
...
# Pattern rule to compile *.cpp class source files in src/chem
...
# Pattern rule to compile *.cc test programs in src/chem/tests
