...
namespace Rp {
      ...
      */
                                         ...
                                         dim3 const meshDims)
      {
         ...
         if (ix < meshDims.x && iy < meshDims.y && iz < meshDims.z) {
            ...
            dPhidL = dPhidL * (dPhidL - 1) * 8.0 * ( std::abs(d - 0.5) - 0.5 )
                     / interfaceThickness;
   ...
   */
   ...
   double FilmFieldGenExt<D,CUT>::stress(int paramId) const
   {
      ...
      HostArray<cudaReal*,CUT> hDerivPtrs_h(nMonomer);
      ...
      HostArray<cudaReal,CUT>  chiBottom_h(nMonomer), chiTop_h(nMonomer);
   ...
   */
   ...
   void FilmFieldGenExt<D,CUT>::compute()
   {
      ...
      HostArray<cudaReal*,CUT> hPtrs_h(nMonomer);
