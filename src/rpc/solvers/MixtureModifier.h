...
#include <prdc/solvers/MixtureModifierReal.h>  // base class template
...
namespace Rpc {
   ...
   * Prdc::MixtureModifierReal< Rpc::Mixture<D> > and has the same public
   * interface as this base class. See documentation of base class.
   *
   * \ingroup Rpc_Solver_Module
   */
   template <int D>
   class MixtureModifier : public MixtureModifierReal< Mixture<D> >
   {
...
namespace Prdc {
   ...
   extern template class MixtureModifierReal< Rpc::Mixture<1> >;
   extern template class MixtureModifierReal< Rpc::Mixture<2> >;
   extern template class MixtureModifierReal< Rpc::Mixture<3> >;
} // namespace Prdc
} // namespace Pscf
#endif
