...
namespace Pscf {
   namespace Rp {
      extern template class ExplicitBdStep<1, Rpc::Types<1> >;
      extern template class ExplicitBdStep<2, Rpc::Types<2> >;
      extern template class ExplicitBdStep<3, Rpc::Types<3> >;
   }
}
#endif
