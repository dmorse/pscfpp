...
namespace Pscf {
namespace Rp {
   extern template class CompressorFactory<1, Rpc::Types<1> >;
   extern template class CompressorFactory<2, Rpc::Types<2> >;
   extern template class CompressorFactory<3, Rpc::Types<3> >;
}
}
#endif
