...
namespace Pscf {
   extern template 
   class AmIteratorTmpl< Rp::Compressor<1, CppTp<1> >, FftwDRArray<double> >;
   extern template 
   class AmIteratorTmpl< Rp::Compressor<2, CppTp<2> >, FftwDRArray<double> >;
   extern template 
   class AmIteratorTmpl< Rp::Compressor<3, CppTp<3> >, FftwDRArray<double> >;
}
#endif
