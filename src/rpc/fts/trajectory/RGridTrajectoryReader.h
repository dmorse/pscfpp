...
namespace Pscf {
   namespace Rp {
      extern template class RGridTrajectoryReader<1, Cpp<1> >;
      extern template class RGridTrajectoryReader<2, Cpp<2> >;
      extern template class RGridTrajectoryReader<3, Cpp<3> >;
   }
}
#endif
