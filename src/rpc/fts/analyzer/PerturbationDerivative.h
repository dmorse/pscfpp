...
namespace Pscf {
   namespace Rp {
      extern template class PerturbationDerivative< 1, Cpp<1> >;
      extern template class PerturbationDerivative< 2, Cpp<2> >;
      extern template class PerturbationDerivative< 3, Cpp<3> >;
   }
}
#endif
