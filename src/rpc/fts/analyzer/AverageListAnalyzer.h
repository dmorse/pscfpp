...
namespace Pscf {
   namespace Rp {
      extern template class AverageListAnalyzer<1, CppTp<1> >;
      extern template class AverageListAnalyzer<2, CppTp<2> >;
      extern template class AverageListAnalyzer<3, CppTp<3> >;
   }
}
#endif
