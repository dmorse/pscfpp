...
namespace Pscf {
   namespace Rp {
      extern template class ConcentrationDerivative<1, CppTp<1> >;
      extern template class ConcentrationDerivative<2, CppTp<2> >;
      extern template class ConcentrationDerivative<3, CppTp<3> >;
   }
}
#endif
