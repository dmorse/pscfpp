...
namespace Pscf {
   namespace Rp {
      extern template class ConcentrationDerivative<1,CPT>;
      extern template class ConcentrationDerivative<2,CPT>;
      extern template class ConcentrationDerivative<3,CPT>;
   }
}
#endif
