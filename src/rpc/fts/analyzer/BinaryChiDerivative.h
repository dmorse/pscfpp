...
namespace Pscf {
   namespace Rp {
      extern template class BinaryChiDerivative<1, CppTp<1> >;
      extern template class BinaryChiDerivative<2, CppTp<2> >;
      extern template class BinaryChiDerivative<3, CppTp<3> >;
   }
}
#endif
