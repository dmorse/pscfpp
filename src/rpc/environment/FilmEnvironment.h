...
namespace Pscf {
   namespace Rp {
      extern template class FilmEnvironment<1, Rpc::Types<1> >;
      extern template class FilmEnvironment<2, Rpc::Types<2> >;
      extern template class FilmEnvironment<3, Rpc::Types<3> >;
   } 
} 
#endif
