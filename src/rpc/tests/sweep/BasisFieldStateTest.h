...
public:
   ...
   void testConstructor()
   {
      ...
      Rp::BasisFieldState<3,CPT> bfs1(system);
      Rp::BasisFieldState<3,CPT> bfs2;
   }
   ...
   void testRead()
   {
      ...
      Rp::System<3,CPT> system;
      Rp::BasisFieldState<3,CPT> bfs(system);
   ...
   void testWrite()
   {
      ...
      Rp::System<3,CPT> system;
      Rp::BasisFieldState<3,CPT> bfs1(system), bfs2(system);
      BFieldComparison comparison;
   ...
   void SetUpSystem(Rp::System<3,CPT>& system)
   {
