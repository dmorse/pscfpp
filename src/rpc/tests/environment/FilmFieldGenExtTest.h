...
public:
   ...
   void testConstructor()
   {
      ...
      Rp::FilmFieldGenExt<1,CPT> ext(system);
   }
   ...
   void testCheckCompatibility() // test FieldGenerator::checkCompatibility()
   {
      ...
      Rp::FilmFieldGenExt<1,CPT> ext1(system1);
      ...
      Rp::FilmFieldGenExt<2,CPT> ext2(system2);
      ...
      Rp::FilmFieldGenExt<3,CPT> ext3(system3);
   ...
   void testGenerate() // test FieldGenerator::generate()
   {
      ...
      Rp::FilmFieldGenExt<3,CPT> ext1(system1);
      ...
      // Set up external field
      Rp::FilmFieldGenExt<3,CPT> ext2(system2);
   ...
   void testStress() // test FilmFieldGenExt::stress
   {
      ...
      // Set up external field generator
      Rp::FilmFieldGenExt<2,CPT> ext(system);
   ...
   template <int D>
   void createFilmFieldGenExt(Rp::FilmFieldGenExt<D,CPT>& ext, std::string fname)
   {
      std::ifstream in;
      openInputFile(fname, in);
      ext.readParameters(in);
   ...
   template <int D>
   bool checkCheckCompatibility(Rp::FilmFieldGenExt<D,CPT>& ext, bool expectError)
   {
      bool pass = true;
      if (expectError) {
         try {
