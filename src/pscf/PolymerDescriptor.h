#ifndef PSCF_POLYMER_DESCRIPTOR_H
#define PSCF_POLYMER_DESCRIPTOR_H
...
{ 
   ...
   */
   ...
   private:
      ...
      /// Total length of all blocks = length in units of reference length.
      double length_;
   ...
   * Total length of all blocks = volume / reference volume
   */
   inline double PolymerDescriptor::length() const
   {  return length_; }
