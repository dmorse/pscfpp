...
This is a copy of readme.txt file obtained with the tar ball of the
mtrand package. The file names are the same as described below, but 
some files have been moved: The test files mttest.cpp and mttest.out 
have been moved into a directory tests/ of the directory containing
the header and source files mtrand.h and mtrand.cpp.

----- The rest of this file is unmodified --------------------
