...
namespace Pscf {
   template class 
   AmIteratorTmpl< Rp::Iterator<1, Rpg::Types<1> >, DArray<double> >;
   template class 
   AmIteratorTmpl< Rp::Iterator<2, Rpg::Types<2> >, DArray<double> >;
   template class 
   AmIteratorTmpl< Rp::Iterator<3, Rpg::Types<3> >, DArray<double> >;
   namespace Rp {
