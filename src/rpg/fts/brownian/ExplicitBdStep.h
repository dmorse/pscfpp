...
namespace Pscf {
   namespace Rp {
      extern template class ExplicitBdStep<1, Rpg::Types<1> >;
      extern template class ExplicitBdStep<2, Rpg::Types<2> >;
      extern template class ExplicitBdStep<3, Rpg::Types<3> >;
   }
}
#endif
