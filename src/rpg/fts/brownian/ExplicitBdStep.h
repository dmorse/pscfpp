...
#include <pscf/cuda/CudaTp.h>                 // base template argument 
...
namespace Pscf {
   namespace Rp {
      extern template class ExplicitBdStep<1, CudaTp<1> >;
      extern template class ExplicitBdStep<2, CudaTp<2> >;
      extern template class ExplicitBdStep<3, CudaTp<3> >;
   }
}
#endif
