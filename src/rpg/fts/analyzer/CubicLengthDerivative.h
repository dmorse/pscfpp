...
namespace Pscf {
   namespace Rp {
      extern template class CubicLengthDerivative<1, CudaTp<1> >;
      extern template class CubicLengthDerivative<2, CudaTp<2> >;
      extern template class CubicLengthDerivative<3, CudaTp<3> >;
   }
}
#endif
